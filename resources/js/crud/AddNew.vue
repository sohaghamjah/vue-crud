                    ...
                    <div class="card-body">
                      <form @submit.prevent="storeData">
                        <div class="mb-3">
                          ...
                          <input type="name" v-model="form.name" class="form-control" id="name" placeholder="Enter name">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="Phone" v-model="form.phone" class="form-control" id="Phone" placeholder="Enter your phone">
